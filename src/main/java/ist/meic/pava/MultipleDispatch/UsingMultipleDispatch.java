...
public class UsingMultipleDispatch {
    ...
    /**
     * Implements a Breadth-First-Search for finding and returning the most
     * specific method for the given argument types.
     ...
     */
    static Method bestMethod(Class<?> receiverType, String name,
